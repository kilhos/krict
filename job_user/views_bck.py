...
def smiles_result():
    ...
    for index, job_result in enumerate(job_results):
        ...
        if running_job.module_api.module_api_cd == 'CD001':
            urls = "http://10.39.149.110:8081/predict_deep_hit?content=" + parse.urlencode(content)
        elif running_job.module_api.module_api_cd == 'CD002':
            urls = "http://10.39.149.110:8084/predict_bbbp?content=" + parse.urlencode(content)
        elif running_job.module_api.module_api_cd == 'CD003':
            urls = "http://10.39.149.110:8082/predict_cyp?content=" + parse.urlencode(content)
        elif running_job.module_api.module_api_cd == 'CD004':
            urls = "http://10.39.149.110:8082/predict_herg?content=" + parse.urlencode(content)
        elif running_job.module_api.module_api_cd == 'CD005':
            urls = "http://10.39.149.110:8084/predict_ms?content=" + parse.urlencode(content)
        elif running_job.module_api.module_api_cd == 'CD006':
            urls = "http://10.39.149.110:8083/predict_chemtrans?content=" + parse.urlencode(content)
        print(urls)
